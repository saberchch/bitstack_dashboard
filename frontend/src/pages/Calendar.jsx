...
export default function Calendar() {
  ...
  useEffect(() => {
    const handleSync = () => setSessions(getCalendarSessions());
    window.addEventListener(CALENDAR_SYNC_EVENT, handleSync);
    return () => window.removeEventListener(CALENDAR_SYNC_EVENT, handleSync);
  }, []);

  useEffect(() => {
    saveCalendarSessions(sessions, { notify: false });
  }, [sessions]);
